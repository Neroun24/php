    ...
    <div class="container px-2">
        ...
        <div class="footer-contacts">
            ...
            <ul class="footer-contacts-list">
                ...
                <li class="footer-contacts-list-item">
                    <p class="footer__heading">доб. 16049</p>
                    <p class="footer__paragraph">Плодовые культуры</p>
                </li>
                <li class="footer-contacts-list-item">
                    <p class="footer__heading">доб. 43835</p>
                    <p class="footer__paragraph">Мясо, молоко, птица, яйцо</p>
                </li>
                <li class="footer-contacts-list-item">
                    <p class="footer__heading">Студеникина Мария Михайловна</p>
                </li>
                <li class="footer-contacts-list-item">
                    <p class="footer__paragraph"><a class="footer__link" href="mailto:studenikina_mm@magnit.ru">studenikina_mm@magnit.ru</a></p>
                </li>
            </ul>
