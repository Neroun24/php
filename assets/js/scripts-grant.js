$(async function () {
            ...
            ({ path, name }) => `
                        <li class="grants-description-document">
                            ...
                            <div class="grants-description-document__icon-wrap">
                                <img
                                src="img/icons/document-icon.svg"
  ...
  const {
    ...
    forms,
    vectors
  } = await fetch("https://agro.604.ru/ajax/centers/getFilter.php").then((response) => response.json());
  ...
  $("#grantsForm").validate({
    ...
    submitHandler: async function (form, event) {
      ...
      let hadError = false;
      const result = await fetch("https://agro.604.ru/ajax/centers/getCenters.php", {
        method: "POST",
        headers: {
